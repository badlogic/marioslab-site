...
var r96_12_hello_dos = (() => {
  var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
  
  return (
function(r96_12_hello_dos) {
  r96_12_hello_dos = r96_12_hello_dos || {};
...
var Module = typeof r96_12_hello_dos != 'undefined' ? r96_12_hello_dos : {};
...
["_malloc","_free","_main","_reverse_color_channels","_window_data_set_mouse_pos","_window_data_set_mouse_wheel","_window_data_set_mouse_button","_window_data_set_key","_window_data_set_mod_keys","_window_data_get_specific","_window_data_call_active_func","_window_data_call_resize_func","_window_data_call_close_func","_window_data_call_keyboard_func","_window_data_call_char_input_func","_window_data_call_mouse_btn_func","_window_data_call_mouse_move_func","_window_data_call_mouse_wheel_func","_window_data_get_close","_fflush","onRuntimeInitialized"].forEach((prop) => {
...
var wasmBinaryFile;
  wasmBinaryFile = 'r96_12_hello_dos.wasm';
...
function __asyncjs__load_file(path,size) { return Asyncify.handleAsync(async () => { let url = "./" + UTF8ToString(path); let response = await fetch(url); if (!response.ok) return 0; let data = new Uint8Array(await response.arrayBuffer()); let ptr = _malloc(data.byteLength); HEAPU8.set(data, ptr); HEAPU32[size >> 2] = data.byteLength; return ptr; }); }
...
var asmLibraryArg = {
  ...
  "__asyncjs__load_file": __asyncjs__load_file,
  ...
  "mfb_timer_tick_js": mfb_timer_tick_js,
...
var ___start_em_js = Module['___start_em_js'] = 69660;
var ___stop_em_js = Module['___stop_em_js'] = 79778;
...
run();
  ...
  return r96_12_hello_dos.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = r96_12_hello_dos;
else if (typeof define === 'function' && define['amd'])
  define([], function() { return r96_12_hello_dos; });
else if (typeof exports === 'object')
  exports["r96_12_hello_dos"] = r96_12_hello_dos;
